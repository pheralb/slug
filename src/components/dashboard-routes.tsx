      ...
      <div className="flex items-center space-x-7">
        {DashboardRoutes.map((route) => (
          <Link
            ...
            href={route.path}
            className={cn(
              "group relative px-1 pt-3 pb-4 text-sm font-medium outline-2 outline-sky-400 transition-colors duration-100 hover:bg-transparent hover:text-neutral-900 focus-visible:outline dark:hover:text-white",
              pathname === route.path
